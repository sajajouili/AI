...
const perguntas = [
  {
    ...
    alternativas: [" Máquinas imitando sentimentos ", " Máquinas realizando tarefas humanas."]
  },
  {
    enunciado: " O que é IA generativa? ",
    alternativas: [" IA que cria novos conteúdos ", " IA que repete conteúdos antigos "]
  },
  {
    enunciado: "IA em carros autônomos? ",
    alternativas: [" Carros que dirigem sozinhos ", " Carros que só fazem cálculos de velocidade "]
  }
];
